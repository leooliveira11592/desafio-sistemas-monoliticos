...
describe("Client Repository test", () => {
  ...
  */
  ...
  it("should create a client Repository", async () => {
    ...
    const result = await clientFacade.find({ id: client.id });
    const clientDb = await ClientModel.findOne({ where: { id: client.id } });

    console.log("::::::::::: result.id: " + result.id);
    console.log("::::::::::: clientDb.id: " + clientDb.id);
  ...
  it("should find a client Repository", async () => {
